				...
				<?php if ($rekanan !== []) : ?>
					<?php foreach ($rekanan as $rekan) : ?>
						<tr>
							...
							<td>
								<a <?php if ($this->session->userdata('role') === 'guest') echo 'class="d-none"' ?> href="<?php echo base_url() ?>rekanan/ubahrekanan/<?php echo $rekan['id'] ?>" class="btn btn-warning"><i class="far fa-edit"></i></a>
								<a <?php if ($this->session->userdata('role') === 'guest') echo 'class="d-none"' ?> href="<?php echo base_url() ?>rekanan/hapusrekanan/<?php echo $rekan['id'] ?>" class="btn btn-danger" onclick="return confirm('apakah anda yakin?')"><i class="fas fa-trash"></i></a>
							</td>
						<?php endforeach; ?>
					<?php else : ?>
