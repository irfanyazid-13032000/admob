    ...
    <div class="col-md-10">
    				...
    				<?php foreach ($perjanjian as $janji) : ?>
    					<tr>
    						...
    						<?php if ($janji['keaktifan'] === 'aktif') : ?>
    							...
    							<td>
    								<a <?php if ($this->session->userdata('role') === 'guest') echo 'class="d-none"' ?> href="<?php echo base_url() ?>perjanjian/ubahperjanjian/<?php echo $janji['id_perjanjian'] ?>" class="btn btn-warning"><i class="far fa-edit"></i></a>
    								<a href="<?php echo base_url() ?>perjanjian/lihatperjanjian/<?php echo $janji['id_perjanjian'] ?>" class="btn btn-success"><i class="fas fa-search"></i></a>
    								<a <?php if ($this->session->userdata('role') === 'guest') echo 'class="d-none"' ?> href="<?php echo base_url() ?>perjanjian/hapusperjanjian/<?php echo $janji['id_perjanjian'] ?>" class="btn btn-danger" onclick="return confirm(`Apakah Anda Yakin ingin menghapus data <?php echo $janji['no_perjanjian'] ?> ?`)"><i class="fas fa-trash"></i></a>
    	...
    	<a <?php if ($this->session->userdata('role') === 'guest') echo 'class="d-none"' ?> href="<?php echo base_url() ?>perjanjian/tambahperjanjian" type="button" class="btn btn-info"><i class="fas fa-plus-circle"></i></a>
